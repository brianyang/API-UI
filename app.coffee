...
# }}}
    ...
    k5app.removeWorkCatAll = (req,res) ->
      WorkCat.find({}).remove()
      res.send 'done all'

    k5app.removeServiceCatAll = (req,res) ->
      ServiceCat.find({}).remove()
      res.send 'done all'
    ...
    k5app.listWorkCat = (req,res) ->
      res.render 'list-workCat.ejs'

    k5app.addWorkCatAdmin = (req,res) ->
      res.render 'add-workCat.ejs'

    k5app.listServiceCat = (req,res) ->
      res.render 'list-serviceCat.ejs'

    k5app.addServiceCatAdmin = (req,res) ->
      res.render 'add-serviceCat.ejs'
    ...
    k5app.addTags = (req,res) ->
      ...
      Tag.findOne {tag: req.params.tag}, (error,project) ->
        if(error)
          ...
          tag.project.push(req.query.project)
          console.log project
    ...
    k5app.checkTag = (req,res) ->
      # issues:
      #  - server restart stores duplicate project ids
      #  - server crashes where tag not created

      Tag.find tag:req.params.tag, (error,tag) ->
        queryArr = []
        $(tag[0].project).each (i,l) ->
          console.log l
          console.log req.query.project

          queryArr.push l

          # dont push onto array, will loop. create new array and return

        console.log 'queryArr'# {{{
        console.log queryArr
        queryIndex = queryArr.indexOf(req.query.project)
        console.log 'queryIndex'
        console.log queryIndex
        console.log queryArr
        queryArr.splice(queryIndex, 1) if queryIndex > -1
        console.log queryArr# }}}
        tag[0].project.push(req.query.project)
        saveTag = ->
          console.log 'saveTag'
          tag[0].save (error, data) ->
            if(error)
              #res.json error
              console.log error
            else
    ...
    k5app.singleTag = (req,res) ->
      Tag.find {tag: req.params.tag }, (error,data) ->
        res.json data
    ...
    app.get '/listWorkCat', k5app.listWorkCat
    app.get '/addWorkCat', k5app.addWorkCatAdmin
    app.get '/listServiceCat', k5app.listServiceCat
    app.get '/addServiceCat', k5app.addServiceCatAdmin
    ...
    app.get '/v1/tags/:tag', k5app.singleTag
    app.get '/v1/tags/check/:tag', k5app.checkTag
    ...
    app.delete '/v1/workCat', k5app.removeWorkCatAll
    app.delete '/v1/serviceCat', k5app.removeServiceCatAll
